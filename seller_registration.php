...
<form action="upload_registration_details_seller.php" method="POST" enctype="multipart/form-data"> 
<div class="container">
...
<input type="file" id=""  name="Aadhar" required>
</div>

<div class="form-group">
<label>Upload Pan Card:</label>
<input type="file" id=""  name="Pan" required>
</div>
