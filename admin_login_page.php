<?php 
include 'dbcon.php';
$file = file_get_contents('admin_invalid_page.php');
$next_page = file_get_contents('admin_main_page.html');
...
<b>Admin Username</b><input type="text" name="Username"  placeholder="Username" required>
...
elseif($_SERVER['REQUEST_METHOD']=='POST')
{
	if(!empty($_POST['submit']))
	{
		...
		if($count>0)
		{
			...
			echo "<br><a href='admin_main_page.html' class='a2' target='_blank'>Proceed</a>";
		}
		else
		{
			echo $file;
