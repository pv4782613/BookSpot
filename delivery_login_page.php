<?php 
include 'dbcon.php';
$file = file_get_contents('delivery_invalid_page.php');
$next_page = file_get_contents('delivery_main_page.html');
...
<b>Shipping Agent Username</b><input type="text" name="Username"  placeholder="Username" required>
...
elseif($_SERVER['REQUEST_METHOD']=='POST')
{
	if(!empty($_POST['submit']))
	{
		...
		$query="select * from delivery_registration where Username='$Username' and Password='$Password'";
		...
		if($count>0)
		{
			...
			echo "<br><a href='delivery_main_page.html' class='a2' target='_blank'>Proceed</a>";
		}
		else
		{
			echo $file;
